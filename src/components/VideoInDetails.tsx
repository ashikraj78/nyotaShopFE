...
function VideoInDetails(props: VideoInDetailsProps) {
  ...
  return (
    <div className="mx-4 my-4 md:mx-36 md:my-16 md:flex align-stretch">
      <Image
        src={"/nyota_videoImage_image.svg"}
        width={800}
        height={500}
        alt="Flower Br"
        className="w-full relative  md:videoWidth z-8"
      />
      <div className="children1 md:ml-16 md:pr-8 md:border-r flex flex-col justify-between w-full">
        <div className="flex justify-between md:mb-8">
          <div>
            <h3 className="thirdTextColor font-normal text-3xl ">
              {title || "Kalamkari Wedding Invites"}
            </h3>
            <p className="thirdTextColor font-light text-base mt-2">
              {subTitle || "Subtle colours and soothing music"}{" "}
            </p>
          </div>
          <p className="text-2xl font-black thirdTextColor">{cost || 2500}/-</p>
        </div>
        <div className="flex md:my-8">
          <p className="thirdTextColor w-4/12 border-b text-center text-xl py-2 font-black">
            Description
          </p>
          {/* <p className="thirdTextColor w-4/12 border-b border-l border-r text-center text-xl py-2 font-light">
            Features
          </p>
          <p className="thirdTextColor w-4/12 border-b text-center text-xl py-2 font-light">
            Process
          </p> */}
        </div>
        <p className="text-base font-light thirdTextColor ">
          {description ||
            "Subtle colours and soothing music makes this rhythmic wedding invitation a true classic. Buy this soft video personalised with your photos, text and religious theme. It can be customised to include all the functions of your wedding. Subtle colours and soothing music makes this rhythmic wedding invitation a true classic. Buy this soft video personalised with your photos, text and religious theme. It can be customised to include all the functions of your wedding."}
        </p>
        <button
          className="h-12 w-full primaryColor py-auto text-xl secondaryTextColor my-4 md:mt-12 "
          onClick={handleBuyNow}
        >
          Buy Now
        </button>
      </div>
      <div className="children2 flex md:flex-col justify-between ml-6">
        ...
        <div className="flex flex-col items-center w-24">
          <div className="mb-2">
            ...
            >
              <path
                d="M15.1667 18V28.6666H4.5V18H15.1667ZM16.5 2.66663L23.8333 14.6666H9.16667L16.5 2.66663ZM23.8333 17.3333C27.1667 17.3333 29.8333 20 29.8333 23.3333C29.8333 26.6666 27.1667 29.3333 23.8333 29.3333C20.5 29.3333 17.8333 26.6666 17.8333 23.3333C17.8333 20 20.5 17.3333 23.8333 17.3333Z"
                fill="#274143"
              />
            </svg>
          </div>
        ...
        <div className="flex flex-col items-center w-24">
          <div className="mb-2">
            ...
            >
              ...
              />
              <path
                d="M12 22.6667V5.33337H25.3333V22.6667M12 10.6667H25.3333"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
