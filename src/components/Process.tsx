...
function Process() {
  ...
  return (
    <div>
      ...
      <div className="h-72 primaryColor pt-8">
        <h3 className="text-center mb-8 secondaryTextColor text-2xl font-light">
          Our Process
        </h3>
        <div className="flex justify-center ">
          <div className="relative">
            ...
            <p className="secondaryTextColor text-xl font-light mt-4 absolute top-16  template_text1">
              Choose a Template
            </p>
          </div>
          ...
          <div className="relative">
            <div className="flex items-center ">
              ...
              <p className="secondaryTextColor text-xl font-light mt-4 absolute top-16 template_text2">
                Customize
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <p className="secondaryTextColor text-xl font-light mt-4 absolute top-16 w-44 template_text1">
              Pay and Download
            </p>
          </div>
        </div>
