...
function ThankModal(){
   ...
   return(
       ...
       >
           ...
           <p className="text-center mb-10 mt-2 text-xl font-bold text-lime-700" >Payment done Successfully</p>
           <p className="text-center">You will be redirect to <b>order page</b> shortly</p>
